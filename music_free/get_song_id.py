...
class Encrypyed():
    ...
    def aes_encrypt(self,text, key):
        ...
        encryptor = AES.new(key.encode('utf-8'), AES.MODE_CBC, bytes(iv,encoding='utf8'))
...
class search():
    ...
    def search_song(self, search_content,search_type=1, limit=9, index =0):
        """
        根据音乐名搜索
...
if __name__ == '__main__':
    d=search()
    print(d.search_song('Love yourself-JustinBieber'))